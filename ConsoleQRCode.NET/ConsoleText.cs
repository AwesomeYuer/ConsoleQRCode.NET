namespace Microshaoft
{
    ...
    public static class ConsoleText
    {
        ...
        {
            readonly CharLengthSegment[] collection;
            public CharLengthSegments(CharLengthSegment[] collection)
            {
                this.collection = collection;
                Array.Sort(collection);
            }

            public CharLengthSegment this[int index] => collection[index];
            ...
            public CharLengthSegment BinarySearch(char c)
            {
                ...
                while (low <= high)
                {
                    ...
                    CharLengthSegment curSeg = this[middle];
            ...
            {
                foreach (CharLengthSegment each in collection)
                    yield return each;
            }
        ...
        {
            return CalculateCharLength(c) > 1;
        }
        public static int CalculateCharLength(char c)
        {
            return AllCharsLengthSegments.BinarySearch(c).Length;
        }
